...
- Acts as a captive portal: connecting to the AP should auto-open a browser straight
  ...
  is a restricted mini-browser (no tabs, no bookmarking) — the small chip in the
  dashboard header copies the device's address so you can back out of it and paste
  the address into Safari/Chrome yourself.
